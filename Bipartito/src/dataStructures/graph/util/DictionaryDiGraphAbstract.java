...
public abstract class DictionaryDiGraphAbstract<T> extends DictionaryDiGraph<T>{
	private static String CONECTOR = "--";
	private String conector;

	public DictionaryDiGraphAbstract(String cadena) {
		this(cadena, CONECTOR);
	}
	
	public DictionaryDiGraphAbstract(String cadena, String conector) {
